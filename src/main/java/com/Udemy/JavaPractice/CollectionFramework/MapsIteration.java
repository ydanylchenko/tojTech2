...
public class MapsIteration {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Integer, String> entry: hashMap.entrySet()) { // map iteration
        ...
        // LinkedHashMap Maintain the order in which they are added
        ...
        // TreeMap Maintains natural sorting
